...
class GroupCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_comment" do
    assert_difference('GroupComment.count') do
      post group_comments_url, params: { group_comment: { comment: @group_comment.comment, group_message_id: @group_comment.group_message_id, user_id: @group_comment.user_id } }
    end
  ...
  test "should update group_comment" do
    patch group_comment_url(@group_comment), params: { group_comment: { comment: @group_comment.comment, group_message_id: @group_comment.group_message_id, user_id: @group_comment.user_id } }
