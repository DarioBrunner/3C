...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { login: @channel.login, title: @channel.title, typ: @channel.typ, url: @channel.url } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { login: @channel.login, title: @channel.title, typ: @channel.typ, url: @channel.url } }
