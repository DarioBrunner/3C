...
#
# Company.find_or_create_by({ :companyname => "Proofpoint",:adress => "Steckengaße", :passwort=>"false"})
#
# Group.find_or_create_by({:title =>"Trainer.all"})
# Group.find_or_create_by({:title =>"Yoga"})
# Group.find_or_create_by({:title =>"Stepper"})
# Group.find_or_create_by({:title =>"Condition"})
#
# User.find_or_create_by({:email => 'super@super.com', :company_id => '1', :name => "super", :admin=> "false",:superuser=>"true",:password => "123",:password_confirmation => "123"})
# User.find_or_create_by({:email => 'admin@admin.com', :company_id => '1', :name => "admin", :admin=> "true",:superuser=>"false",:password => "123",:password_confirmation => "123"})
# User.find_or_create_by({:email => '1@1.com', :company_id => '1', :name => "cat1", :admin=> "false",:superuser=>"false",:password => "123",:password_confirmation => "123"})
# User.find_or_create_by({:email => '2@2.com', :company_id => '1', :name => "cat2", :admin=> "false",:superuser=>"false",:password => "123",:password_confirmation => "123"})
# User.find_or_create_by({:email => '3@3.com', :company_id => '1', :name => "wokeecat", :admin=> "false",:superuser=>"false",:password => "123",:password_confirmation => "123"})
#
#
...
GroupMessage.find_or_create_by({:group_id =>"1", :context =>context1})
GroupMessage.find_or_create_by({:group_id =>"2", :context=>context2})
GroupMessage.find_or_create_by({:group_id =>"3", :context =>context3})
GroupMessage.find_or_create_by({:group_id =>"1", :context =>context4})
GroupMessage.find_or_create_by({:group_id =>"2", :context=>context5})
GroupMessage.find_or_create_by({:group_id =>"1", :context =>context6})
GroupMessage.find_or_create_by({:group_id =>"1", :context =>context7})
GroupMessage.find_or_create_by({:group_id =>"4", :context=>context8})

#GroupComment.find_or_create_by({:group_message_id => '1', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '1', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '1', :user_id => '3', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '2', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '2', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '3', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '3', :user_id => '1', :comment =>'Jup wird erledigt.'})
#GroupComment.find_or_create_by({:group_message_id => '4', :user_id => '1', :comment =>'Jup wird erledigt.'})
